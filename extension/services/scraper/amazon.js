...
window.AmazonScraper = (() => {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // 참고: Amazon은 product-reviews 페이지에 X-Frame-Options: DENY 설정
  //       fetch()도 Sec-Fetch-Mode 체크로 차단
  //       → 상품 페이지 DOM 10개가 현재 extension에서 가능한 최대치
  //       향후: chrome.tabs API로 백그라운드 탭 스크래핑 고려
  // ─────────────────────────────────────────────────────────────────────────
